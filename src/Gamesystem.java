...
public class Gamesystem {
    private List<Entita> eList =new ArrayList<Entita>();
    ...
    public void selezioneAttore() {
        ...
        if(Attore == 0){
           System.out.println("Benvenuto Admin!");
            ...
            eList.add(new Entita(nomeEroe, classeEroe));
            eList.get(eList.size()-1).CreaEroe();//CREAZIONE EROE    
        }
    }
    ...
    public void mostraScheda() {
        ...
        input.nextLine();
        String nomeEntita = input.nextLine();

        for (Entita e : eList) {
            if (e.getNome().equals(nomeEntita)) {
